...
namespace SamJUK\DemoPackage\Test\Integration;
...
class DemoTest extends TestCase
{
     ...
     */
    public function testModuleIsRegisteredAndActive(): void
    {
        $moduleList = Bootstrap::getObjectManager()->get(ModuleListInterface::class);

        $this->assertTrue(
            $moduleList->has('SamJUK_DemoPackage'),
            'Module not registered - integration DB bootstrap did not run against a real Magento install.'
        );
    }
    ...
    public function testCanWriteAndReadConfigFromDatabase(): void
    {
        ...
        $path = 'samjuk_demo_package/test/value';
        $value = 'demo-' . uniqid();
